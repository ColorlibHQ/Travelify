 ...
 *
 * The demo is captured live from https://colorlibhub.com/travelify/, so this needs a network connection and
...
const DEMO = 'https://colorlibhub.com/travelify/';
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .card{position:relative;width:1280px;height:640px;background:#0e1a12;overflow:hidden}
  ...
  .glow{position:absolute;left:-300px;top:-340px;width:940px;height:940px;border-radius:50%;
        background:radial-gradient(circle,rgba(87,173,104,.30) 0%,transparent 62%)}
  ...
  .mark{width:52px;height:52px;border-radius:15px;background:#57ad68;
        display:grid;place-items:center;color:#fff;font-size:26px;font-weight:700;
        box-shadow:0 8px 24px rgba(87,173,104,.30)}
  ...
  h1 i{font-style:normal;color:#7fd191;display:block}
  ...
  .chip--on{border-color:#57ad68;color:#7fd191;background:rgba(87,173,104,.30)}
...
<div class="card">
  ...
  <div class="body">
    <div class="brand"><div class="mark">T</div><b>Travelify</b></div>
    <h1>A travel &amp; blog<i>WordPress theme</i></h1>
    <p>Featured post slider, left or right sidebar and WooCommerce support — with no jQuery on the front end.</p>
    <div class="chips"><span class="chip chip--on">Free &amp; GPLv2</span><span class="chip">Zero jQuery</span><span class="chip">WooCommerce ready</span></div>
  </div>
  <div class="shot"></div>
</div>`;
